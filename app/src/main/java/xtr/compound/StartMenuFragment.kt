...
class StartMenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<RecyclerView>(R.id.apps_list)?.setAdapter(AppsGridAdapter(activity, R.layout.app_list_item));
        view.findViewById<RecyclerView>(R.id.apps_grid)?.setAdapter(AppsGridAdapter(activity, R.layout.app_grid_item));
        return view
    }
